...
# TUTORIAL = environ.get("TUTORIAL", "https://t.me/the_hell_king_updates")   # Tutorial link for verification
# TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/the_hell_king_updates")   # Second tutorial link for verification
# TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/the_hell_king_updates")   # Third tutorial link for verification
...
# # ============================
# GRP_LNK = environ.get('GRP_LNK', 'https://t.me/the_hell_king_updates') # Group link for the bot
# OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/the_hell_king_updates') # Owner link for the bot
# UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/the_hell_king_updates') # Update channel link for the bot
...
# # Add this line around line 170 in info.py
# SEND_ALL_MODE_PREMIUM_ONLY = bool(environ.get('SEND_ALL_MODE_PREMIUM_ONLY', True))  # SendAll button is premium only by default
...
# ============================
SESSION = environ.get('SESSION', 'dreamxbotz_search')   # Session name for the bot
API_ID = int(environ.get('API_ID', '27972068')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '6e7e2f5cdddba536b8e603b3155223c1')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "6753180750:AAGGAQ7o00N5xAD3YqKK7Gj3Yx1ZV_HVJes")    # Bot token from @BotFather
...
INDEX_CAPTION = bool(environ.get('SAVE_CAPTION', True)) # Save caption db when idexing make it False if you dont use USE_CAPTION_FILTER for search results (default: True)
#Making it false will not save caption in db SO you can save some storage space
DAILY_DOWNLOAD_LIMIT = int(environ.get("DAILY_DOWNLOAD_LIMIT", "3")) 
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002089352638 -1002070999511")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002089352638 -1002070999511")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/e419f801841c2ee30fc.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'subhadeepsamui2006@okaxis')    # Owner UPI ID for payments
...
# MongoDB Configuration
# ============================
DATABASE_URI = environ.get('DATABASE_URI', 'mongodb+srv://hellking:hellking@cluster0.hylyhjp.mongodb.net/?appName=Cluster0')  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'dreamcinezone_files') # Collection name (default: dreamcinezone_files)

# If MULTIPLE_DB Is True Then Fill DATABASE_URI2 Value Else You Will Get Error.
MULTIPLE_DB = is_enabled(os.environ.get('MULTIPLE_DB', "False"), False) # Type True For Turn On MULTIPLE DB FUNTION 
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://hellking2:hellking2@cluster0.xrkk1hw.mongodb.net/?appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
# Movie Notification & Update Settings
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATION', False))  # Notification On (True) / Off (False)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002089352638'))  # Notification of sent to your channel
DREAMXBOTZ_IMAGE_FETCH = bool(environ.get('DREAMXBOTZ_IMAGE_FETCH', True))  # On (True) / Off (False)
LINK_PREVIEW = bool(environ.get('LINK_PREVIEW', False)) # Shows link preview in notification msg instead of image
ABOVE_PREVIEW = bool(environ.get('ABOVE_PREVIEW', True)) # Shows link preview above the text in notification msg if True else below the msg
TMDB_API_KEY = environ.get('TMDB_API_KEY', 'c83a22a71ba60632da9d3a91cd5a9274') # preffer to use your own tmdb API Key get it from https://www.themoviedb.org/settings/api
TMDB_POSTER = bool(environ.get('TMDB_POSTER', True)) # Shows TMDB poster in notification msg
LANDSCAPE_POSTER = bool(environ.get('LANDSCAPE_POSTER', True)) # Shows landscape poster in notification msg
...
# ============================
IS_VERIFY = is_enabled('IS_VERIFY', False)  # Verification On (True) / Off (False)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002146616379')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002146616379')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")
...
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/The_hell_king_movie_group') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/the_hell_king_updates') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/the_hell_king_updates') # Update channel link for the bot
